...
setup(
    ...
    keywords ='empty_image_data_filler image_data_filler empty_swath_filler data_filler swath_filler image_filler filler image data swath empty', 
